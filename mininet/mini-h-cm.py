...
if __name__ == '__main__':
    ...
    setLogLevel('info')
    net = Minievents(topo=TreeTopo(depth=5,fanout=1), link=TCLink, controller=OVSController, events_file=args.events)
    net.start()
    #h1, h2 = net.get('h1','h2')
    #h2.cmd('vlc-wrapper rtp://@:5004')
    #h1.cmd('vlc-wrapper -vvv file:////home/mininet/Downloads/video1.avi --sout \
     #       "#rtp{dst=10.0.0.2,port=5004,mux=ts}" \
      #      --run-time 80 vlc://quit &')
